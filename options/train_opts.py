...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--solver',      default='adam', help='adam|sgd|RMSprop') #RMSprop ADDED
        ...
        self.parser.add_argument('--momentum',    default=0.9,  type=float, help='sgd|RMSprop')
        self.parser.add_argument('--alpha',       default=0.99, type= float, help= 'RMSprop')
