...
class Criterion(object):
    ...
    def setupNormalCrit(self, args):
        ...
        # calculate normal loss with SoftMargin or hinge EmbeddingLoss ADDED Function 
        elif args.normal_loss == 'SoftMargin':
            self.n_crit = torch.nn.SoftMarginLoss()
        elif args.normal_loss == 'HingeEmbedding':
            self.n_crit = torch.nn.HingeEmbeddingLoss()
        #//////////////////////////////////////////////////////////////
        else:
    ...
    def forward(self, output, target):
        if self.normal_loss == 'cos':
            ...
            self.loss = self.normal_w * self.n_crit(output, target, self.flag)
         #required modifications on loss methodes /////////////////////////////////////
        elif self.normal_loss == 'SoftMargin':
            self.loss = self.normal_w * self.n_crit(output, target)
        elif self.normal_loss == 'HingeEmbedding':
            self.loss = self.normal_w * self.n_crit(output, target)
        #
        #/////////////////////////////////////////////////////////////////////////////
...
def getOptimizer(args, params):
    ...
    #ajouter une autre methode d'optimization :////////////////////////////////////////////////////////////////////////
    elif args.solver == 'RMSprop':
        optimizer = torch.optim.RMSprop(params, args.init_lr, alpha=args.alpha, momentum=args.momentum)
    #/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    else:
